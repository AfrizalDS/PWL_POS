                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="date" class="form-control" id="penjualan_tanggal" name="penjualan_tanggal"
                                value="{{ old('penjualan_tanggal', \Carbon\Carbon::parse($penjualan->penjualan_tanggal)->format('Y-m-d')) }}"
                                required>
        ...
        $(document).ready(function() {
            ...
            function updateTotalHarga() {
                $('tbody tr').each(function() {
                    ...
                    // Menghilangkan ,00 jika totalHarga merupakan bilangan bulat
                    var formattedTotal = totalHarga % 1 === 0 ? totalHarga.toFixed(0) : totalHarga.toFixed(
                        2);
                    $(this).find('.total_harga').val(formattedTotal);
                });
            }
